...
exports.getLoanOffer = exports.submitLoanRequest = exports.validateLoanRequest = void 0;
...
exports.validateLoanRequest = [
    (0, express_validator_1.body)('loanValue').isNumeric().withMessage('Loan value must be a number'),
    (0, express_validator_1.body)('term').isInt({ min: 1 }).withMessage('Term must be a positive integer')
];
...
const submitLoanRequest = (req, res) => {
    ...
    const lenderOffers = (0, generateLenderOffers_1.generateLenderOffers)(loanValue, term);
    (0, offerService_1.saveOffer)(id, { loanRequest: { loanValue, term }, offers: lenderOffers });
